...
// @description Type the a phone number redirects you to a chat window, even if it's not in your contacts list
// @version     1.0.0
// @author      icetbr
...
const init = () => {
    ...
    var $input = `<input id="unsavedContactPhoneNumber" placeholder="Phone number" title: "Ex: 5547999783456" class="Er7QU" style="${style}" onkeyup="icetbr_redirect(event)">`;
    $searchBox.insertAdjacentHTML('beforeend', $input);

    var hidden = true;
    var togglePhoneNumber = () => {
    ...
    $communityButton.insertAdjacentHTML('beforebegin', $button);
